...
# Bot token
BOT_TOKEN = "7922646161:AAHIyddwyfxfaT3GXeQUBYHn80My4mPHWkc"

# Admin IDs
OWNER_ID = 6095233308
MAIN_ADMIN_ID = 6670048452

ADMIN_IDS = {OWNER_ID, MAIN_ADMIN_ID}
...
async def visit(update: Update, context: CallbackContext):
    ...
    if chat_id not in allowed_groups:
        await update.message.reply_text(
            "Please join our group to interact with the bot seamlessly. Here's the link to join: https://t.me/+9QUCINqR9EVkMjQ9"
        )
        return
...
async def checkspam(update: Update, context: CallbackContext):
    ...
    if user_id in vip_users and vip_users[user_id]['days_left'] > 0:
        ...
        await update.message.reply_text(
            ...
            "OWNER - @BLACKSELLER14 ✔️\n"
            "JOIN MY GROUP - https://t.me/+9QUCINqR9EVkMjQ9\n"
        )
    else:
        await update.message.reply_text(
            f"🔍 Your Status:\n"
